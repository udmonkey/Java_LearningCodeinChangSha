    ...
    <table border="0" cellspacing="0" cellpadding="0"  class="wukuang"width="100%">
        <tr>
            ...
            <td width="57%"align="right">
                <a href="${pageContext.request.contextPath}/users?method=toAdd">
                    <img src="${pageContext.request.contextPath}/images/button/cjyh.gif" /></a>
                <a href="${pageContext.request.contextPath}/users?method=toBatchAdd">
                    <img src="${pageContext.request.contextPath}/images/button/pltj.png"/></a>
                <a href="${pageContext.request.contextPath}/users?method=gaoJiChaXun">
    ...
    <table width="100%" border="1" >
        ...
        <tr class="tabtd2">
            ...
            <td width="7%" align="center">
                <a href="${pageContext.request.contextPath}/users?method=findUserById&uid=${user.uid}">
                    <img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"></a>
                <a href="javascript:checkDel('${user.uid}')">
