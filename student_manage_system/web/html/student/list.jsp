...
<table width="100%" border="1" >
    ...
    <tr class="tabtd2">
        ...
        <td align="center">
            <a href="${pageContext.request.contextPath}/students?method=findStudentById&sid=${student.sid}">
                <img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"></a>
            <a href="javascript:checkDel('${student.sid}')">
                <img src="${pageContext.request.contextPath}/images/button/delete.gif" class="img"></a>
        </td>
    </tr>
    </c:forEach>
</table>
<table border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td align="right">
            <span>第${pageContext.request.session.getAttribute("pageinfo").getPageNum()}/3页</span>
            <span>
        	<a href="${pageContext.request.contextPath}/students?method=firstPage">[首页]</a>&nbsp;&nbsp;
            <a href="${pageContext.request.contextPath}/students?method=lastPage">[上一页]</a>&nbsp;&nbsp;
            <a href="${pageContext.request.contextPath}/students?method=nextPage">[下一页]</a>&nbsp;&nbsp;
            <a href="${pageContext.request.contextPath}/students?method=tailPage">[尾页]</a>
        </span>
        </td>
    </tr>
</table>
